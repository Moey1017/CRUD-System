 let btn = document.getElementsByClassName("options");
                            ...
                            $('.create__button').click(function (e) {
                                e.preventDefault();
                                $(this).addClass('active');
                                $('.create__button').removeClass('active');
                                $('.login__form').show();
                                $('.register__form').hide();
                            ...
                            /*look for any elements with the class "comp-select":*/
                            x = document.getElementsByClassName("comp-select");
